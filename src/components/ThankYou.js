    ...
    <div className="min-h-screen flex items-center justify-center bg-surface px-6">
      ...
      >
        ...
        <p className="text-on-surface-variant mb-10 leading-relaxed">
          Thank you for reaching out to Zoic Biotech. Our engineering team has received your technical requirements and will contact you within 24 business hours.
        </p>
